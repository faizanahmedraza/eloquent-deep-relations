        ...
        <div class="card my-sm-5">
            ...
            <div class="card-body">
                <form action="/employee/add" method="POST">
                    ...
                    <div class="mb-2 row">
                        <label class="col-md-2 form-label">Shop/Store Name</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="shop" value="">
                        </div>
                    </div>
                    <div class="mb-2 row">
                    ...
                    <div class="mb-2 row">
                        <label class="col-md-2 form-label">Employee Name</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="employee_name" value="">
                        </div>
                    </div>
                    <div class="mb-2 row">
                        <label class="col-md-2 form-label">Employee Email</label>
                        <div class="col-md-10">
                            <input type="email" class="form-control" name="employee_email" value="">
                        </div>
                    </div>
                    <div class="mb-2 row">
